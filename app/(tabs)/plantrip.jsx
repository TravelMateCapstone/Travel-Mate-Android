...
import { View, Text, TextInput, TouchableOpacity, StyleSheet, FlatList, Keyboard, Platform, ScrollView } from 'react-native';
...
export default function PlanTripScreen() {
    ...
    const handleStartPlanning = () => {
        if (!destination || !days || !nights || !companions || !budget || !validateDates()) {
